...
var initialState = {
  ...
  reactFlowVersion: "10.0.0-next.38" ,
    ...
    return _objectSpread(_objectSpread({}, initialState), {}, {
      ...
      addSelectedNodes: function addSelectedNodes(selectedNodeIds) {
        var _get4 = get(),
            ...
            hasDefaultNodes = _get4.hasDefaultNodes; // @TODO: work with nodeInternals instead of converting it to an array
      ...
      unselectNodesAndEdges: function unselectNodesAndEdges() {
        var _get6 = get(),
            ...
            hasDefaultEdges = _get6.hasDefaultEdges; // @TODO: work with nodeInternals instead of converting it to an array


        var nodes = Array.from(nodeInternals).map(function (_ref4) {
...
export { updateEdge as A, getTransformForBounds as B, ConnectionLineType as C, BackgroundVariant as D, getD3Transition as E, fitView as F, pointToRendererPoint as G, getBoundsofRects as H, MarkerType as M, PanOnScrollMode as P, _arrayLikeToArray as _, _unsupportedIterableToArray as a, _slicedToArray as b, useStore as c, getDimensions as d, clamp as e, getNodesInside as f, getConnectedEdges as g, getSelectionChanges as h, _defineProperty as i, getRectOfNodes as j, Position as k, getMarkerId as l, ConnectionMode as m, getHostForElement as n, isNumeric as o, addEdge as p, Provider as q, rectToBox as r, createStore as s, applyEdgeChanges as t, useStoreApi as u, applyNodeChanges as v, isNode as w, isEdge as x, getOutgoers as y, getIncomers as z };
//# sourceMappingURL=index-a3f26c81.js.map
