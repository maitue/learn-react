import { _ as _arrayLikeToArray, a as _unsupportedIterableToArray, b as _slicedToArray, u as useStoreApi, c as useStore, g as getConnectedEdges, d as getDimensions, P as PanOnScrollMode, e as clamp, f as getNodesInside, h as getSelectionChanges, i as _defineProperty, j as getRectOfNodes, k as Position, C as ConnectionLineType, M as MarkerType, l as getMarkerId, m as ConnectionMode, n as getHostForElement, r as rectToBox, o as isNumeric, p as addEdge, q as Provider$1, s as createStore, t as applyEdgeChanges, v as applyNodeChanges } from './index-a3f26c81.js';
export { D as BackgroundVariant, C as ConnectionLineType, m as ConnectionMode, M as MarkerType, P as PanOnScrollMode, k as Position, p as addEdge, t as applyEdgeChanges, v as applyNodeChanges, g as getConnectedEdges, z as getIncomers, y as getOutgoers, j as getRectOfNodes, B as getTransformForBounds, x as isEdge, w as isNode, A as updateEdge, c as useStore, u as useStoreApi } from './index-a3f26c81.js';
import { _ as _objectWithoutProperties, u as useViewportHelper } from './useViewportHelper-f703d1a3.js';
...
var useGlobalKeyHandler = (function (_ref) {
  ...
  useEffect(function () {
    var _store$getState = store.getState(),
        ...
        hasDefaultEdges = _store$getState.hasDefaultEdges; // @TODO: work with nodeInternals instead of converting it to an array
    ...
    if (deleteKeyPressed && (selectedNodes || selectedEdges)) {
      ...
      var edgeIdsToRemove = [].concat(_toConsumableArray(selectedEdges), _toConsumableArray(connectedEdges)).map(function (e) {
        return e.id;
      });
...
var UserSelection = /*#__PURE__*/memo(function (_ref) {
  ...
  var onMouseMove = function onMouseMove(event) {
    ...
    var nextUserSelectRect = _objectSpread$b(_objectSpread$b({}, userSelectionRect), {}, {
...
var ConnectionLine = (function (_ref) {
  ...
  if (connectionLineType === ConnectionLineType.Bezier) {
    ...
    dAttr = getSmoothStepPath(_objectSpread$9(_objectSpread$9({}, pathParams), {}, {
      borderRadius: 0
    }));
...
var StepEdge = /*#__PURE__*/memo(function (props) {
  return /*#__PURE__*/React__default.createElement(SmoothStepEdge, _objectSpread$7(_objectSpread$7({}, props), {}, {
    borderRadius: 0
  }));
});
...
function createEdgeTypes(edgeTypes) {
  ...
  return _objectSpread$6(_objectSpread$6({}, standardTypes), specialTypes);
}
...
function Viewport(_ref) {
  var children = _ref.children;
  var transform = useStore(selector$5);
  return /*#__PURE__*/React__default.createElement("div", {
...
function useReactFlow() {
  var _useViewportHelper = useViewportHelper(),
      ...
      viewportHelperFunctions = _objectWithoutProperties(_useViewportHelper, _excluded$2);
  ...
  return _objectSpread$5(_objectSpread$5({}, viewportHelperFunctions), {}, {
...
var SelectionListener = (function (_ref5) {
...
export { BezierEdge, EdgeText$1 as EdgeText, Handle$1 as Handle, SmoothStepEdge, StepEdge, StraightEdge, ReactFlow as default, getBezierPath, getCenter as getEdgeCenter, getMarkerEnd, getSmoothStepPath, useEdges, useEdgesState, useKeyPress, useNodes, useNodesState, useReactFlow, useUpdateNodeInternals, useViewport };
